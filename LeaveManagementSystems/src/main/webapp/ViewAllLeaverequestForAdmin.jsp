				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					...
					<div class="navbar-nav ms-auto" style="font-size: 18px;color:#861F41;text-transform:capitalize; ">
						<a href="dashboard.jsp" class="nav-item nav-link"style="font-size: 16px;color:#333;text-transform:capitalize;font-family: Lato-Regular; ">Dashboard</a>
						 <a class="nav-item nav-link"style="font-size: 16px;color:#333;text-transform:capitalize;font-family: Lato-Regular; " href="viewapproverejectforadmin">Approval History</a>
   ...
   <!-- Table  -->
    ...
    <table class="table table-striped table-hover" style= "width:96%;margin-left:30px;margin-top:15px;margin-bottom:30px;margin-right:30px;box-shadow: 3px 3px 3px 3px  #861F41" >
        ...
        <c:forEach items="${applyleave }" var="applyleave">
           ...
           <td><a href="approveleaveofManager?lid=<c:out value='${applyleave.lid }'/>"><button
                    class="btn btn-light" onclick="return confirm('Do you want to Approve Leave?');" >Approve</button></a></td>
                <td><a href="rejectleaveofmanager?lid=<c:out value='${applyleave.lid}'/>"><button
