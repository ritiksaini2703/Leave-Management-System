...
<body style="height: 1100px;">
	<header class="header">
		...
		<a class="nav-item nav-link" href="viewManagerDashboard?id=<c:out value='${employee.id }'/>" class="nav-item nav-link"style="font-size: 16px;color:#333;text-transform:capitalize;font-family: Lato-Regular; ">Dashboard</a>
