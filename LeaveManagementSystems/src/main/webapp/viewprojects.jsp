   ...
   <!-- Table  -->
    ...
    <table class="table table-striped table-hover" style= "margin-left:3px;margin-top:15px;margin-bottom:30px;margin-right:30px;box-shadow: 3px 3px 3px 3px  #861F41" >
        <tr> <div class="panel-heading">
            <center> <div class="panel-title"style="font-size: 30px;color:#861F41;"><b>Project List</b></center>
					</div><br>
        ...
        <c:forEach items="${project}" var="project">
            <tr>
                ...
                <td>${project.asignedemployees}</td>
                ...
                <td><a href="pdelete?id=<c:out value='${project.projectid }'/>"><button
